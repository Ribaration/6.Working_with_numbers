...
namespace _6.Working_with_numbers
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //BODMAS sill applies, 4+2*3 gets 10, use brackets to change the order
            Console.WriteLine(4 + 2 * 3);

            //whatever you do with integers, you get an integer back
            Console.WriteLine(5 / 2); //you going to get 2, not 2,5
            ...
            // calling methods e.g the Math method, Abs means Absolute
            //you always will get the positive number
